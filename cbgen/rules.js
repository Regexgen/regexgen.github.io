const rules = {
		...
		'Условия': [
            '<ul>\n',
                ...
                '\t<li class="big" style="color: #999">',
                    ...
                    {
                        'limits.amountPerReceipt': 'До {3} шт. в чеке. '
                    },
                    {
        ...
        'Условия': [
            ...
            '<ol>\n',
                ...
                },
                {
                    ...
                    'accumulationType.milestones': '{подробное описание акционных товаров со всеми критериями}. За покупку {[milestone] получите Y[rewardUnit], [milestone] — Y[rewardUnit], [milestone] — Y[rewardUnit]}. Товары могут быть в одном или нескольких чеках.</li>\n',
    ...
    'Полные (юридические) условия': {
        'Контент блока': [
            ...
            {
                'limits.amountPerReceipt': '\t<li>До {3} шт. в чеке.</li>\n'
            },
            {
