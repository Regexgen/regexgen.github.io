    ...
    'Полные условия': {
        'Условия': [
            ...
            '<ol>\n',
                ...
                `\t<li>Сохраните чек.</li>
                \t<li>Нажмите на кнопку сканирования в приложении «Едадил». Отсканируйте чек в течение 48 часов после покупки.</li>\n`,
                {
                    '_c.accumulationType != "immediate"': '\t<li>Мы засчитаем покупку после проверки чека.</li>\n'
                },
                {
                    'rewardType.money': {
                        'accumulationType.immediate': '\t<li>Дождитесь начисления кэшбэка и переведите средства на телефон или кошелек в ЮMoney.</li>\n',
                        'accumulationType.milestones': '\t<li>Забирайте кэшбэк, когда накопите нужную сумму. Переведите средства со счета на телефон или кошелек в ЮMoney.</li>\n',
                        'accumulationType.paws': '\t<li>После покупки N штук дождитесь начисления кэшбэка. Переведите средства со счета на телефон или кошелек в ЮMoney.</li>\n'
                    },
                    'rewardType.coupon': {
