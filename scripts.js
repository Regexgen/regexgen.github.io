$(document).ready(function() {
	...
	function start1() {
		...
		text = text.replace(/(б(?!class\=))/gi,"[бb6]");
		text = text.replace(/(в(?!class\=))/gi,"[вb]");
		...
		text = text.replace(/(з(?!class\=))/gi,"[з3]");
		text = text.replace(/(и(?!class\=))/gi,"[иui]");
		...
		text = text.replace(/(о(?!class\=))/gi,"[оo0]");
		text = text.replace(/(п)/gi,"[пn]");
		text = text.replace(/(р)/gi,"[рp]");
		text = text.replace(/(с(?!class\=))/gi,"[сcs]");
		...
		text = text.replace(/(0(?!class\=))/gi,"[0оo]");
		text = text.replace(/(1(?!class\=))/gi,"[1i]");
		text = text.replace(/(2(?!class\=))/gi,"[2z]");
		text = text.replace(/(3(?!class\=))/gi,"[3з]");
		text = text.replace(/(5(?!class\=))/gi,"[5s]");
		text = text.replace(/(6(?!class\=))/gi,"[6бb]");
		text = text.replace(/(8(?!class\=))/gi,"[8вb]");
